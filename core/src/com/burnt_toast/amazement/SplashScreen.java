...
public class SplashScreen implements Screen{
	...
	public SplashScreen(MainFrame passMain){
		...
		//FIXME change to the correct font name in file
		main.generator = new FreeTypeFontGenerator(Gdx.files.internal("Data-lakj;lskjef.ttf"));
		main.parameter = new FreeTypeFontParameter();
		main.parameter.size = 12;//FIXME will probably need bigger font size
